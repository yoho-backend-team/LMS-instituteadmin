...
const HelpFAQ = () => {
 ...
 const handleSelectChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
  ...
  return (
    <div className=''>
        <div className='bg-[#CA406F] p-5 text-white text-lg rounded-md font-bold'>CUSTOMER</div>


        <div className='bg-white w-full mt-7 p-5 rounded-2xl shadow-2xl'>
          <div className='justify-center text-center text-[#716F6F] font-bold text-2xl'>Hello, How Can We Help You</div>
          <select className='bg-white mt-5 w-2/5 h-12 ring-1 ring-[#716F6F] rounded text-[#716F6F]'
          ...
          <div className='flex flex-col text-[#716F6F] gap-4'>
            <span className='text-lg text-[#CA406F] font-semibold'>For assistance related to your orders</span>
        ...
        <div className='grid grid-cols-4 mt-5 gap-5 text-[#716F6F]'>
            <div className='bg-white p-5 rounded-2xl shadow-2xl'>
              <div className='bg-[#CA406F] w-12 h-11 rounded-md p-3'><IoMdCall className='fill-white h-6 w-6'/></div>
            ...
            <div className='bg-white p-5 rounded-2xl shadow-2xl'>
              <div className='bg-[#CA406F] w-12 h-11 rounded-md p-3'><IoMdMail className='fill-white h-6 w-6'/></div>
