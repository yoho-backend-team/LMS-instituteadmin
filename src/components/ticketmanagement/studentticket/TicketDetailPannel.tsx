...
const TicketDetailPanels: React.FC = () => {
  ...
  return (
    <div className="p-6 w-full flex flex-col gap-4">
      ...
      <IoIosArrowBack
        ...
        onClick={() => navigate("/Studentticket")} // Go back to previous page
      />

      {/* Title */}
      <h3 className="text-3xl font-bold text-gray-500">Student Ticket</h3>
    </div>
...
export default TicketDetailPanels;
