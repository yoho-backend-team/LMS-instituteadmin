...
const AddEditModal: React.FC<AddEditModalProps> = ({ isOpen, onClose, onSubmit, editingStudent, isEditing }) => {
      ...
      <div className="w-full h-[90vh] rounded-lg flex flex-col shadow-xl">
        <div className="flex-1 overflow-y-auto hide-scrollbar">
          ...
          <div className="flex items-center justify-between px-6 py-4 rounded-t-2xl border-b bg-white border-gray-200 sticky top-0 z-10">
            <h2 className="text-2xl font-semibold text-[#CA406F]">{isEditing ? "Edit Student" : "Add New Student"}</h2>
            <button onClick={onClose} className="bg-black text-white rounded-full p-1 hover:bg-gray-800">
          ...
          <div className="bg-white p-5 rounded-b-2xl">
            ...
            >
              ...
              <p className="text-sm text-gray-500">
                <img src={upload || "/placeholder.svg"} alt="upload" className="mx-auto mb-2" />
          ...
          <div className="bg-white p-5 rounded-lg mt-5 shadow">
            ...
            <div className="p-5 flex rounded-lg justify-end gap-4 bottom-0 z-10">
              ...
              <button onClick={handleSubmit} className="bg-[#CA406F] text-white px-4 py-2 rounded-md">
