...
const Navbar = () => {
  return (
    <nav className="   w-full h-20  bg-gradient-to-r from-[#F6D3E9] via-[#FFFFFF] to-[#F6D3E9] shadow-md p-3 flex items-center justify-between">
      
      <div className="flex items-center">
        <img src={Titlelogo} alt="Logo" className="h-10 w-auto px-5 "  />
        <div>
