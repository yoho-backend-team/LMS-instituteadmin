...
const SideBar = ({
    ...
    return (
        <div
            className={`top-0 left-0 h-full z-40 flex flex-col transition-all duration-300 p-1 bg-gradient-to-b from-[#F6D3E9] via-[#FFFFFF] to-[#F6D3E9] ${actualOpen ? "w-60" : "w-25"}`}
        ...
        >
            ...
            <div className="flex items-center justify-between p-4 h-16">
                <div className="relative group flex items-center overflow-visible">
                    <button
                        ...
                        className="px-5 rounded-md transition duration-200 hover:bg-white/10"
                        title="Toggle Sidebar"
                    >
                        <Menu size={20} className="text-[#CA406F]" />
                    </button>
                    <span className="absolute left-full top-1/2 -translate-y-1/2 ml-4 whitespace-nowrap rounded-3xl bg-[#CA406F] text-white text-sm px-4 py-1 shadow-lg opacity-0 group-hover:opacity-100 z-50">
                        Toggle Sidebar
                    </span>
                </div>
            </div>
            <nav className="flex-1 overflow-visible p-2 text-black relative space-y-3">
                ...
                >
                    <SidebarLink1 to="/branch" label="Branch" isOpen={actualOpen} onClick={handleLinkClick} />
                </SidebarDropdown>
                <SidebarDropdown
                    icon={<UserSearch />}
