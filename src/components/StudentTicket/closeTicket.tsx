      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mt-6">
        <div className="lg:col-span-2 bg-white shadow rounded-xl p-4 flex flex-col max-h-[75vh]">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              ...
              <p className="!text-green-500"style={{...FONTS.Description}}>Active Now</p>
            </div>
          </div>
          ...
          >
            ...
            <div className="flex gap-2 mt-4">
              <Button variant="outline" className="border-[#ca406f] !bg-[transparent] !text-[grey]"style={{...FONTS.add_button}}>
                Solved
              </Button>
        ...
        <div className="bg-white shadow rounded-xl p-4 space-y-4">
          ...
          <div>
            ...
            <p className=" !text-blue-600 underline cursor-pointer"style={{...FONTS.input_section}}>
          ...
          <div>
            ...
            <span className="bg-[green] px-4 py-2  rounded-md text-sm font-semibold"style={{...FONTS.add_button}}>
              Closed
            </span>
          </div>
        </div>
