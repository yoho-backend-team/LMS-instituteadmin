  ...
  const plans = [
    {
      ...
      image: box1,
      isCurrent: true,
      btnClass: "bg-white text-pink-600 border border-pink-600",
    ...
    },
    {
      ...
      image: box1,
      isCurrent: false,
      btnClass: "bg-pink-600 text-white border border-pink-600",
  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto bg-white/90 shadow-xl rounded-xl p-8">
        ...
        {/* Table */}
        <div className="bg-gray-100 rounded-xl p-4 mb-10 border  overflow-x-auto">
          <table className="w-full text-sm text-left">
            ...
            <tbody>
              <tr className="bg-white">
                <td className="px-4 py-3 font-semibold text-gray-600">#84</td>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {plans.map((plan, idx) => (
            <div
              key={idx}
              className={`rounded-xl shadow-lg overflow-hidden flex flex-col items-center py-6 px-4 ${plan.bgClass}`}
            >
              <img
                src={plan.image}
                alt={plan.title}
              ...
              {!plan.isCurrent && (
                <button
                  className={`w-full mt-2 py-2 font-semibold rounded-md ${plan.btnClass}`}
                >
                  Upgrade Plan
                </button>
              )}
