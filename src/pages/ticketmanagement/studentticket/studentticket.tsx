...
import TicketTabs from "@/components/ticketmanagement/studentticket/TicketTabs";
import TicketCard, { type Ticket } from "@/components/ticketmanagement/studentticket/TicketCard";
  ...
  return (
    <div className="flex flex-col lg:flex-row gap-6 p-6">
      ...
      <div className="flex-1 flex-col flex gap-8">
        ...
        <h2 className="text-2xl font-bold ">STUDENT TICKETS</h2>
        </div>
