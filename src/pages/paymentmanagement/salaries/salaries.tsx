...
const Salaries: React.FC = () => {
    ...
    const salaryData: SalaryRecord[] = [
        ...
        { id: '#31', transactionId: '987654', staff: 'Elon Musk Musk@Gmail.Com', salaryAmount: '$4,000', paymentDate: '2025‑05‑07', status: 'Active' },
        { id: '#4', transactionId: '123456', staff: 'Elon Musk Musk@Gmail.Com', salaryAmount: '$80,000', paymentDate: '2025‑05‑07', status: 'Active' },
        { id: '#5', transactionId: '765432', staff: 'Elon Musk Musk@Gmail.Com', salaryAmount: '$290,700', paymentDate: '2025‑05‑07', status: 'Active' },
        { id: '#6', transactionId: '876543', staff: 'Elon Musk Musk@Gmail.Com', salaryAmount: '$8,777,000', paymentDate: '2025‑05‑07', status: 'Active' },
    ];
